...
################## Backlog from 20th September,2023(Backward)   ##############################################################
...
query = f"SELECT c.id,c.title,c.published_date, c.published_date_time,c.author,c.url,c.content_cl FROM c WHERE c.published_date >='2023-06-21' AND c.published_date <'2023-08-21'"
